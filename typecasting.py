...
<meta name="verify-admitad" content="fb09364f2b" />
    ...
    <script type="text/javascript" src="/public/js/onlinegdb.js?v=10"></script>
    ...
    <script type="text/javascript" src="/public/js/main.js?v=121" defer></script>
...
<span style="float:none;clear:both">&copy; 2016 - 2025 GDB Online</span>
</div>
        </footer>
    ...
    <div class="split-pane-component" id="right-component">
        ...
        <div class="split-pane fixed-left" id="ide-split-pane">
    ...
    <div id="title-bar" style="padding:0px 5px;min-width:900px">
        ...
        <div style="position:relative">
            ...
            <span class="col-sm-63" id="control-bar" style="float:left">
                ...
                <div class="btn-group">
                    <button type="submit" class="btn btn-success" id="control-btn-run" onclick="ide.runcode();" disabled="disabled" data-placement="bottom" data-toggle="tooltip" title="F9"><span
                            class="glyphicon glyphicon-play" aria-hidden="true"></span> Run</button>
                    <button type="submit" id="control-btn-run_x" class="btn btn-success btn-half dropdown-toggle" data-toggle="dropdown" aria-haspopup="true"
                        aria-expanded="false">
                        <span class="caret"></span>
                        <span class="sr-only">Toggle Dropdown</span>
                    </button>
                    <ul class="dropdown-menu">
                        <li><a href="#" onclick="ide.runcode({graphics:true}); track_event('run_gui','run_gui')">Run with display screen (beta)</a></li>
                    </ul>
                </div>
                ...
                <div class="btn-group">
                    <button type="button" class="btn btn-info btn-half" id="control-btn-download" disabled="disabled" onclick="downloadCode()"
                        title="Download Current File" data-placement="bottom" data-toggle="tooltip" title="Ctrl+B"><span
                            class="glyphicon glyphicon-save" aria-hidden="true"></span></button>
                    <button type="button" class="btn btn-info btn-half dropdown-toggle" data-toggle="dropdown" aria-haspopup="true"
                        aria-expanded="false">
                        <span class="caret"></span>
                        <span class="sr-only">Toggle Dropdown</span>
                    </button>
...
<!--                  <option  value="c++11">C++ 11</option> -->
    ...
    <div style="clear:both; background-color:#757575; overflow: auto; scrollbar-width: none;">
        <ul class="editor_file_tabs nav nav-pills" style="display: inline-flex;  overflow-x: scroll; overflow-y: hidden; height: 100px;">
            ...
            <li class="active">
                <a href="#editor_1" data-toggle="tab"><span
                        class="filename">source code</span>
                </a>
    ...
    <div class="editor_text_panes tab-content clearfix">
        ...
        <div id="editor_1" data-format="S" data-readonly-ranges=""
            class="tab-pane active editor" >/******************************************************************************
...
<script>(function(){function c(){var b=a.contentDocument||a.contentWindow.document;if(b){var d=b.createElement('script');d.innerHTML="window.__CF$cv$params={r:'96be5e327d75550a',t:'MTc1NDY0OTMzNy4wMDAwMDA='};var a=document.createElement('script');a.nonce='';a.src='/cdn-cgi/challenge-platform/scripts/jsd/main.js';document.getElementsByTagName('head')[0].appendChild(a);";b.getElementsByTagName('head')[0].appendChild(d)}}if(document.body){var a=document.createElement('iframe');a.height=1;a.width=1;a.style.position='absolute';a.style.top=0;a.style.left=0;a.style.border='none';a.style.visibility='hidden';document.body.appendChild(a);if('loading'!==document.readyState)c();else if(window.addEventListener)document.addEventListener('DOMContentLoaded',c);else{var e=document.onreadystatechange||function(){};document.onreadystatechange=function(b){e(b);'loading'!==document.readyState&&(document.onreadystatechange=e,c())}}}})();</script></body>
